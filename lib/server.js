...
var served = util.debuglog('workers');

//Insratiate the server module
var server = {}
...
server.unifiedServer = function(req,res){
  ...
  req.on('end', function() {
      ...
      chosenHandler(data,function(statusCode,payload, contentType){
        ...
        if(statusCode == 200){
          served('\x1b[32m%s\x1b[0m',trimmedPath,statusCode)
        }
        else {
          served('\x1b[31m%s\x1b[0m',trimmedPath,statusCode)
        }
